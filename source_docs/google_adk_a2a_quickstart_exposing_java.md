---
platform: Google
label: Google ADK — A2A Quickstart: Exposing an Agent (Java)
...
[ ](<https://github.com/google/adk-docs/edit/main/docs/a2a/quickstart-exposing-java.md> "Edit this page on GitHub") [ ](<https://github.com/google/adk-docs/raw/main/docs/a2a/quickstart-exposing-java.md> "View Markdown source")
...
Now that you have exposed your agent via A2A, the next step is to learn how to consume it from another agent orchestrator natively.
  ...
  * [**A2A Quickstart \(Consuming\) for Java**](<../quickstart-consuming-java/>): Learn how your agent orchestrator wrapper connects downstream to exposed services.
