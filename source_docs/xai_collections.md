---
platform: xAI
label: Collections Search Tool
source_url: https://docs.x.ai/docs/guides/tools/collections-search-tool
last_fetched: 2026-05-13
fetch_status: success
notes: WAVE-2 ADD (2026-05-12). Skill B (knowledge) grounding. Suspected summarization. Key facts captured for downstream Skill grounding: tool name `collections_search` (xAI SDK) / `file_search` (OpenAI Responses API); supported formats include PDFs, text files, CSVs; powers RAG workflows; citation URI pattern `collections://[collection_id]/files/[file_id]`; combinable with web_search and x_search tools; targets enterprise, financial analysis, customer support, research, compliance, and personal organization use cases. Research report flagged this as higher-value than plain xai_files for the knowledge skill.
size_bytes: 20547
---
