---
platform: Google
label: Google ADK — A2A Quickstart: Consuming a Remote Agent (Java)
...
[ ](<https://github.com/google/adk-docs/edit/main/docs/a2a/quickstart-consuming-java.md> "Edit this page on GitHub") [ ](<https://github.com/google/adk-docs/raw/main/docs/a2a/quickstart-consuming-java.md> "View Markdown source")
...
Now that you have created an agent that's using a remote agent via an A2A server, the next step is to learn how to expose your own Java agent.
  ...
  * [**A2A Quickstart \(Exposing\) for Java**](<../quickstart-exposing-java/>): Learn how to expose your existing agent so that other agents can use it via the A2A Protocol.
