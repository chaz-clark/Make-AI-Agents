---
platform: Google
label: Google ADK — A2A Quickstart: Consuming a Remote Agent (Go)
...
[ ](<https://github.com/google/adk-docs/edit/main/docs/a2a/quickstart-consuming-go.md> "Edit this page on GitHub") [ ](<https://github.com/google/adk-docs/raw/main/docs/a2a/quickstart-consuming-go.md> "View Markdown source")
