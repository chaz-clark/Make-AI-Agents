---
platform: Google
label: Gemini agentic capabilities (function calling + Google Search)
source_url: https://ai.google.dev/gemini-api/docs/function-calling
source_url_2: https://ai.google.dev/gemini-api/docs/google-search
...
notes: Google RETIRED the standalone agentic-capabilities page in 2026 (between 2026-03-27 and 2026-04-30 refresh cycles). Original URL https://ai.google.dev/gemini-api/docs/agentic-capabilities now returns 404. The concept has been split across topic-specific pages. This cache now combines the 2 closest live successors: function-calling (primary agentic pattern) and google-search (built-in agentic tool). A grounding URL attempted as a third candidate also returned 404. Multi-source pattern matches google_gems_overview.md.
---
<!-- Source 1: https://ai.google.dev/gemini-api/docs/function-calling -->
...
<!-- Source 2: https://ai.google.dev/gemini-api/docs/google-search -->
