...
fetch_error: none
notes: Covers Agent Skills architecture, 3-level progressive disclosure (metadata / instructions / resources), Skill structure (YAML frontmatter + SKILL.md), surfaces where Skills work (API, Claude Code, claude.ai, AWS, Foundry), security considerations, and runtime constraints per surface.
---
# Agent Skills
