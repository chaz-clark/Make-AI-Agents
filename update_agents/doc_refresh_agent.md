...
**Description**: This agent only writes to `source_docs/`. It never touches `make-agent.md`, `make_agent.json`, `make_gems/make_gem_qc.md`, or `make_gems/make_gem_qc.json`.
