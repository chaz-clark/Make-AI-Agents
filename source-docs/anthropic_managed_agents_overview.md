...
[QuickstartCreate your first agent session](</docs/en/managed-agents/quickstart>)[Start a sessionCreate a session and send your first event](</docs/en/managed-agents/sessions>)[ReferenceEvent types, rate limits, CLI flags, and other lookup tables](</docs/en/managed-agents/reference>)
