---
platform: Google
label: Gemini System Instructions (folded into Text Generation page)
...
notes: Google folded the standalone system-instructions page into the broader text-generation page; visiting /system-instructions now returns the text-generation page. Covers generateContent API + system instructions + thinking levels + multimodal inputs. URL unchanged in spec; manual fetch on 2026-05-12 needed because 2026-04-30 WebFetch returned summarized content.
---
# Text generation
