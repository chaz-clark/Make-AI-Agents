...
[Define your agentCreate reusable, versioned agent configurations](</docs/en/managed-agents/agent-setup>)[Configure environmentsCustomize networking and sandbox settings](</docs/en/managed-agents/environments>)[Agent toolsEnable specific tools for your agent](</docs/en/managed-agents/tools>)[Session event streamHandle events and steer the agent mid-execution](</docs/en/managed-agents/events-and-streaming>)[Scheduled deploymentsRun your agent on a recurring cron schedule](</docs/en/managed-agents/scheduled-deployments>)
