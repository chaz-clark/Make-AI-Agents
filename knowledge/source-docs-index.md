...
- `knowledge/behavioral-discipline.md` — the universal discipline (YAML frontmatter + narrative); consumed by every agent including the ones that read this index.
